...
import { createTableDataApi, deleteTableDataApi, updateTableDataApi, getTableDataApi } from "@/api/user"
import { type CreateOrUpdateTableRequestData, type TableData } from "@/api/user/types/table"
...
const columns = ref([
  ...
  { prop: "group_id", label: "用户组", width: "100" },
  { prop: "username", label: "用户名", width: "130" },
  { prop: "nickname", label: "昵称", width: "100" },
  { prop: "avatar", label: "头像", slot: "avatar", width: "100" },
  { prop: "phone", label: "手机号", width: "150" },
  { prop: "email", label: "邮箱", width: "200" },
  { prop: "score", label: "积分", width: "80" },
  { prop: "money", label: "余额", width: "80" },
  { prop: "vip", label: "Vip", width: "80" },
  {
    prop: "status",
    label: "状态",
    width: "80"
...
const formRules: FormRules<CreateOrUpdateTableRequestData> = {
  ...
  email: [{ required: true, trigger: "blur", message: "请输入邮箱", type: "email" }],
